  ...
  return (
    <footer className="footer">
        ...
        <div className="footer__content">
          ...
          <div className="footer__brand">
            <div className="footer__logo">
              ...
              <span className="footer__logo-text">Vafa Acres</span>
            </div>
            <p className="footer__description">
              Discover timeless elegance and natural beauty intertwined at Vafa Acres.
            </p>
      ...
      <div className="footer__copyright">
        <p>Copyright © 2025, Vafa Acres, All Rights Reserved.</p>
      </div>
    </footer>
  );
};
